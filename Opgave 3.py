...
def buildModel(data: dict) -> pyomo.ConcreteModel():
    ...
    model.obj=pyomo.Objective(expr=(sum(model.travel_times[i][j]*model.x[i,j] for i in model.RangeAntalKommuner for j in model.RangeAntalKommuner)), sense=pyomo.minimize)
